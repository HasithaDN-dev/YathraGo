...
export default function PhoneInputScreen() {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      console.log('Request data:', { phone: formattedPhone, userType: 'CUSTOMER' });
    ...
    <View className="flex-1 bg-white">
      ...
      <View className="items-center mt-20 mb-12">
        <Image
          ...
          contentFit="contain"
        />
        <Text className="text-lg font-bold text-blue-900 mt-2">YathraGo</Text>
      </View>

      {/* Content */}
      <View className="px-6">
        <Text className="text-2xl font-bold text-gray-800 mb-2">
          Hi! Welcome to YathraGo
        </Text>
