      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="mx-4 mt-3 mb-6 overflow-hidden rounded-2xl">
          <Image
            ...
            style={{ width: '100%', height: 150, resizeMode: 'cover', borderRadius: 16 }}
          />
          <View className="absolute inset-0 bg-black/35 rounded-2xl px-2 py-4 items-center">
            <Typography variant="footnote" className="text-white text-center">
              Perfect! Now that I can see your YathraGo logo, I can provide much more targeted color palette recommendations that will create a cohesive brand experience throughout your mobile application.
            </Typography>
            <Typography variant="footnote" className="text-white mt-2 text-center">
              I can provide much more targeted color palette recommendations.
            </Typography>
          </View>
        </View>
        ...
        <Card className="mx-4 mb-0 p-0 bg-transparent shadow-none">
          <View className="flex-row justify-between">
            <View className="flex-1 mr-2 bg-white rounded-full px-4 py-3 shadow">
              <Typography variant="footnote" className="text-black">Support-Passenger</Typography>
              <TouchableOpacity onPress={() => handleDial('0117894561')}>
                <Typography variant="subhead" className="text-brand-deepNavy">011 - 7894561</Typography>
              </TouchableOpacity>
            </View>
            <View className="flex-1 ml-1 bg-white rounded-full px-4 py-3 shadow items-center">
              <Typography variant="footnote" className="text-black">Hotline</Typography>
              <TouchableOpacity onPress={() => handleDial('119')}>
                <Typography variant="subhead" className="text-brand-deepNavy">119</Typography>
              </TouchableOpacity>
            </View>
          </View>
        </Card>
        ...
        <Card className="mx-4 mb-0 p-0 bg-transparent shadow-none">
          <View className="bg-white rounded-full px-4 py-3 shadow">
            <Typography variant="footnote" className="text-black">Website</Typography>
            <TouchableOpacity onPress={() => handleLink('https://yathrago.lk')}>
              <Typography variant="subhead" className="text-brand-deepNavy">https://yathrago.lk</Typography>
            </TouchableOpacity>
          </View>
        </Card>
