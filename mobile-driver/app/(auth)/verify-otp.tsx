...
export default function VerifyOTPScreen() {
  ...
  return (
    <View className="flex-1 bg-white px-6 justify-center">
      ...
      <View className="mb-8">
        <Typography variant="title-large" weight="bold" className="text-center text-gray-800 mb-2">
          Verify Phone Number
        </Typography>
        <Typography variant="body-medium" className="text-center text-gray-600 mb-2">
          Enter the 6-digit code sent to
        </Typography>
        <Typography variant="body-medium" weight="semibold" className="text-center text-gray-800">
          {phoneNumber}
        </Typography>
      </View>
      ...
      <View className="space-y-6">
        ...
        {canResend ? (
          <View className="items-center mt-4">
            <TouchableOpacity onPress={handleResendOTP}>
              <Typography variant="body-medium" weight="semibold" className="text-brand-warmYellow">
                Resend OTP
              </Typography>
            </TouchableOpacity>
          </View>
        ...
        <View className="items-center mt-4">
          <TouchableOpacity onPress={() => router.back()}>
            <Typography variant="body-medium" weight="semibold" className="text-gray-600">
              Change Phone Number
            </Typography>
          </TouchableOpacity>
        </View>
