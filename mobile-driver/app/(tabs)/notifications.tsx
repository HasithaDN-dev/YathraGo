...
export default function NotificationsScreen() {
  ...
  React.useEffect(() => {
    ...
    const uniqueSenders = Array.from(new Set(notifications.map((n: NotificationDto) => n.sender))) as string[];
    const filtered = uniqueSenders.filter((sender: string) =>
  ...
  return (
    <SafeAreaView edges={["left","right","bottom"]} className="flex-1 bg-gray-50">
      ...
      {/* Search/Filter Header (from customer UI) */}
