...
export default function DriverCoordinatorSidebar() {
  ...
  const menuItems: MenuItem[] = [
    {
      ...
      label: "Dashboard",
      href: "/driver-coordinator",
    },
    {
      icon: UserCheck,
      label: "Manage Drivers",
      href: "/driver-coordinator/manage-drivers",
    },
    {
      icon: Car,
      label: "Approve Vehicles",
      href: "/driver-coordinator/approve-vehicles",
    },
    {
      icon: MessageSquare,
      label: "Driver Inquiries",
      href: "/driver-coordinator/driver-inquiries",
    },
    {
      icon: AlertTriangle,
      label: "Alert Handling",
      href: "/driver-coordinator/alerts",
    },
    {
      icon: Settings,
      label: "Settings",
      href: "/driver-coordinator/settings",
    },
  ];
  ...
  return (
    <div className="w-64 bg-[var(--color-deep-navy)] text-white flex flex-col h-full">
      ...
      <div className="p-6 border-b border-[var(--light-navy)]">
        ...
        <p className="text-green-100 text-sm mt-1">Driver Coordinator</p>
      </div>
      ...
      <div className="p-4 text-xs text-green-100 border-t border-green-700">
        <div>Driver Coordinator v1.0</div>
