        ...
        <div className="container mx-auto px-6 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
              ...
              <span className="text-yellow-400">Schools & Offices</span>
            </h1>
            ...
            <div className="max-w-2xl mx-auto mb-8">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-lg text-gray-900 focus:ring-2 focus:ring-yellow-400 focus:border-transparent"
                />
                <Button className="absolute right-2 top-2 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold">
                  Find a Vehicle
                </Button>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Button className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-semibold px-8 py-3 text-lg">
                Find a Vehicle
              </Button>
              <Button 
                variant="outline" 
                className="border-white text-blue-900 hover:bg-neutral-gray hover:text-blue-900 px-8 py-3 text-lg"
                asChild
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">School Transport</h3>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Office Transport</h3>
                <p className="text-gray-600">
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow">
              <CardContent className="pt-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Monthly Plans</h3>
                <p className="text-gray-600">
              ...
              <CardContent className="text-center">
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-600">Happy Students & Professionals</p>
                  </div>
                  
                  <div>
                    <div className="text-4xl font-bold text-blue-600 mb-2">500+</div>
                    <p className="text-gray-600">Schools & Offices Served</p>
                  </div>
                  ...
                  <p className="text-sm text-gray-500">Trusted by thousands of families</p>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              ...
              asChild
            >
              <Link href="/owner">Become an Owner</Link>
            </Button>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2 mb-6">
                <Button variant="outline" size="sm" className="w-full border-white text-white hover:bg-white hover:text-blue-900">
                  <Download className="w-4 h-4 mr-2" />
